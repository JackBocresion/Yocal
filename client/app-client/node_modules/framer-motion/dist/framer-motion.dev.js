    ...
    ***************************************************************************** */
            ...
            _this.animate = function (target, origin, _a) {
                ...
                var animations = eachAxis(function (axis) {
                    ...
                    if (visualElement.isTargetBoxLocked) {
                        ...
                        visibilityAction === exports.VisibilityAction.Hide
                            ? visualElement.hide()
                            : visualElement.show();
                    }
                    else if (boxHasMoved) {
    ...
    function createSwitchAnimation(child, stack) {
        if (stack && child !== stack.lead) {
            return { visibilityAction: exports.VisibilityAction.Hide };
        }
        else if (stack &&
            child.presence !== Presence.Entering &&
            child === stack.lead &&
            stack.lead !== stack.prevLead) {
            return { visibilityAction: exports.VisibilityAction.Show };
        }
        var originBox;
        var targetBox;
    ...
    function createCrossfadeAnimation(child, stack) {
        ...
        if (!stack || child === stackLead) {
            ...
            config.visibilityAction = exports.VisibilityAction.Hide;
        }
        return config;
    }
