...
/** @public */
export declare interface LayerProps extends IdentityProps, WillChangeTransformProp {
    children?: ReactNode;
    key?: React.Key;
...
/* Excluded from this release type: ResourceLoading */
 ...
 * @public
 */
export declare const Stack: React.NamedExoticComponent<Partial<StackProperties>>;
