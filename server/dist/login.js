...
server_1.app.post('/register', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
server_1.app.post('/login', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, rows, user_1, e_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 2:
                ...
                if (argon2.verify(user_1.password, password)) {
                    ...
                    crypto.randomBytes(48, function (err, buffer) {
                        ...
                        tokenCache.setex(user_1.uuid, process.env.EXP, token, function (err, result) {
                            if (err) {
                                throw err;
                            }
...
// //it keeps working becasue we just verify then search for them with the data
